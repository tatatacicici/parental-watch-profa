...
val NunitoFontFamily = FontFamily(
    ...
    Font(googleFont = NunitoFontName, fontProvider = provider, weight = FontWeight.ExtraBold),
    Font(googleFont = NunitoFontName, fontProvider = provider, weight = FontWeight.Black)
)
